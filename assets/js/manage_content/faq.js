...
// function load_table() {
	...
	var table =		$("#table1").DataTable({
						...
						ajax : {
							...
							url: base_url + 'admin/Manage_content/dt_faq',
...
function save_data() {
	...
	$.ajax({
		...
		url : base_url+"admin/Content_trx/ajax_simpan_faq",
...
function get_id(id) {
	...
	$.ajax({
		...
		url: base_url + "admin/Content_trx/get_faq_by_id/" + id,
	...
	bootbox.confirm("Yakin akan menghapus data ?", function(event){
		...
		if (event == true) {
			...
			$.ajax({
				...
				url : base_url+'admin/Content_trx/hapus_faq/'+id,
