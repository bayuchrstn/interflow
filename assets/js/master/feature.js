...
// function load_table() {
    ...
    var table = $("#table1").DataTable({
                    ...
                    ajax : {
                        ...
                        url: base_url + 'admin/Master/dt_feature',
...
$('#form-data').submit(function (event) { 
    ...
    $.ajax({
		...
		url: base_url+"admin/Master/ajax_simpan_feature",
...
function get_id(id) {
	...
	$.ajax({
		...
		url: base_url + "admin/Master/feature_id/" + id,
    ...
    bootbox.confirm("Yakin akan menghapus data ?", function(event){
        ...
        if (event == true) {
            ...
            $.ajax({
                ...
                url : base_url+'admin/Master/hapus_feature/'+id,
