    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                html += '';
                html += '<div class="col-lg-4 col-md-4 col-sm-12"><div class="property-box"><div class="property-thumbnail"><a href="'+base_url+'Main/detail_property?q='+property.id+'" class="property-img">'+status_property+'<div class="price-box"><span>Rp '+harga+'</span></div><img class="d-block w-100" src="'+property.image+'" alt="properties"></a></div><div class="detail"><h1 class="title"><a title="'+property.nama+'" href="'+base_url+'Main/detail_property?q='+property.id+'">'+str_name_property+enter_name+'</a></h1><div class="location"><a title="'+str_address_property+'" href="javascript:;"><i class="flaticon-pin"></i></a>'+str_address_property+'</div><hr><ul class="facilities-list clearfix">';

                // list layout //
                html_list += '<div class="col-lg-8 col-md-8 col-sm-8 col-12"><div class="property-box-2"><div class="row"><div class="col-lg-5 col-md-5 col-pad"><div class="property-thumbnail"><a href="'+base_url+'Main/detail_property?q='+property.id+'" class="property-img"><img src="'+property.image+'" alt="properties" class="img-fluid">'+status_property+'<div class="price-box"><span>Rp '+harga+'</span></div></a></div></div><div class="col-lg-7 col-md-7 col-pad align-self-center"><div class="detail"><h3 class="title"><a href="'+base_url+'Main/detail_property?q='+property.id+'">'+property.nama+'</a></h3><h5 class="location"><a href="javascript:;"><i class="flaticon-pin"></i>'+str_address_property+'</a></h5><hr><ul class="facilities-list clearfix">';
...
function loadProperty(page_no) {
    ...
    sort_order = $("#sort_order").val();
    $.ajax({
        url:base_url+"Main/ajax_data_property_list/"+page_no,
        type:"GET",
        data:$("#form_filter").serialize()+"&category="+category+"&premium="+premium+"&sort_order="+sort_order,
        dataType:"JSON",
        beforeSend:function() {
        ...
        success:function(data) {
            ...
            for (let i = 0; i < data_property.length; i++) {
               ...
               /*  if (property.status_transaksi == '0') {
                ...
                html += '';
                html += '<div class="col-lg-4 col-md-4 col-sm-12"><div class="property-box" onclick="loaddetail(this);"><div class="property-thumbnail"><a href="'+base_url+'Main/detail_property?q='+property.id+'" class="property-img">'+status_property+'<div class="price-box"><span>Rp '+harga+'</span></div><img class="d-block w-100" src="'+property.image+'" alt="properties"></a></div><div class="detail"><h1 class="title"><a title="'+property.nama+'" href="'+base_url+'Main/detail_property?q='+property.id+'">'+str_name_property+enter_name+'</a></h1><div class="location"><a title="'+str_address_property+'" href="javascript:;"><i class="flaticon-pin"></i></a>'+str_address_property+'</div><hr><ul class="facilities-list clearfix">';

                // list layout //
                html_list += '<div class="col-lg-8 col-md-8 col-sm-8 col-12"><div class="property-box-2" onclick="loaddetail(this);"><div class="row"><div class="col-lg-5 col-md-5 col-pad"><div class="property-thumbnail"><a href="'+base_url+'Main/detail_property?q='+property.id+'" class="property-img"><img src="'+property.image+'" alt="properties" class="img-fluid">'+status_property+'<div class="price-box"><span>Rp '+harga+'</span></div></a></div></div><div class="col-lg-7 col-md-7 col-pad align-self-center"><div class="detail"><h3 class="title"><a href="'+base_url+'Main/detail_property?q='+property.id+'">'+property.nama+'</a></h3><h5 class="location"><a href="javascript:;"><i class="flaticon-pin"></i>'+str_address_property+'</a></h5><hr><ul class="facilities-list clearfix">';
