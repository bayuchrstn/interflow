...
<div class="content-wrapper">
    <div style="padding-right: 20px;margin-bottom: 10px;">
        <button type="button" title="Add" onClick="show_form()" class="btn btn-primary rounded-round" style="float:right">
            <i class="icon-plus-circle2"></i> Add Fasilitas
    </button>
    </div>
    <!-- Content area -->
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header bg-orange-700">
					<h5 class="modal-title">Form Fasilitas</h5>
				</div>
				<div class="modal-body">
					<form id="form-data">
						<fieldset class="mb-3">
							...
							<div class="form-group row">
								<label class="col-form-label col-md-2">Satuan <br> <b> (Opsional) </b> </label>
								<div class="col-md-10">
									<div class="input-group">
							...
							<div class="form-group row">
								<label class="col-form-label col-md-2">Icon <br> <b> (Opsional) </b> </label>
								<div class="col-md-10">
									<div class="input-group">
