<body>
    ...
    <div class="container">
        <div id="brochure">  <!-- class="col-md-12" -->
            <img src="<?php echo base_url().'assets/img/template/DESAIN E BROSUR.jpg'; ?>" class="responsive-img"> 
            ...
            <table class="content">  <!-- border="1" -->
                <tr>
                    <td rowspan="2">
                        <center>
                            <img src="<?php echo isset($foto->img_url) ? base_url().'assets/img/property/'.$foto->img_name : ''; ?>" class="property-img" height="330px"> <!-- height="330px" -->
                        </center>
                    </td>
                    ...
                    <td class="fasilitas"> 
                        ...
                        <div style="padding-top: 15px; padding-left: 10px; font-size: 18px; height: 50px;">
                            <?php echo isset($data->full_furnish) && $data->full_furnish != "" ? $data->full_furnish : ''; ?>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    ?>
                    <td class="harga"> <?php echo isset($data->harga_jual) ? '<b> Rp '.number_format($data->harga_jual, 0, "", ".").' </b>'.'<br> <b>'.$keterangan_sewa.'</b>' : ''; ?> </td>
                    <td> 
                        <table class="tb-footer">  <!-- border="1" -->
                            <tr>
                                <td class="qr"> 
                                    <div id="qrcode">
                                        <img src="<?php echo base_url().'assets/ebrosur/qrcode/qr_'.$data->id.'.png'; ?>" width="70px" height="70px"> 
                                    </div> 
                                ...
                                <td class="foto-agen">
                                    <img src="<?php echo isset($kontak->profile_img) ? base_url().'assets/img/consultant/'.$kontak->foto_agen : ''; ?>" width="125px">
