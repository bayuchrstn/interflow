...
<div class="content-wrapper">
	<div style="padding-right: 20px;margin-bottom: 10px;">
		<button type="button" title="Add" onClick="show_form()" class="btn btn-primary rounded-round"
			style="float:right">
			<i class="icon-plus-circle2"></i> Add Testimony
		</button>
	</div>
	<!-- Content area -->
			...
			<div class="modal-content">
				...
				<form id="form-data" enctype="multipart/form-data">
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							<label class="col-form-label col-md-2">Testimoni</label>
							<div class="col-md-10">
								<div class="input-group">
								<textarea class="form-control" id="testimoni" name="testimoni" rows="6" placeholder="Input Testimoni"></textarea>
								</div>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-md-2">Upload Foto Profil</label>
							<div class="col-md-8">
								<div class="input-group">
