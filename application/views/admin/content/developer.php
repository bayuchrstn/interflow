...
<div class="content-wrapper">
	...
	<div style="padding-right: 20px;margin-bottom: 10px;">
		...
		<button type="button" title="Add" onClick="show_form()" class="btn btn-primary rounded-round"
			...
			<i class="icon-plus-circle2"></i> Add Developer
				...
				<form id="form-data" enctype="multipart/form-data">
						...
						<fieldset class="mb-3">
							...
							<div class="form-group row">
								...
								<label class="col-form-label col-md-2">Name Tag</label>

								<div class="col-md-10">

									<div class="input-group">

										<input type="text" id="name_tag" name="name_tag" class="form-control">
							...
							<div class="form-group row">
								...
								<label class="col-form-label col-md-2">Developer Name</label>
							...
							<div class="form-group row">
								...
								<label class="col-form-label col-md-2">Upload Logo</label>
							...
							<div class="form-group row">
								...
								<label class="col-form-label col-md-2">Upload PDF</label>
								...
								<div class="col-md-8">
									...
									<span class="form-text text-muted">Ukuran File max. <b> 4250 KB / 4.25 MB </b> </span>
